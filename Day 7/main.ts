...
let guests: string[] = ["Albert Einstien", "Marie Curie",
...
let countries: string[] = ["Japan", "Canada", "New Zeland", "Iceland", "Switzerland"];
...
let book: {titel: string; author: string; yearPubluished:
    number} = {
        titel: "The Hobbit",
