...
console.log(`Albert Einstein once said, "A person who never made a mistake never tried
anything new"`);
//Question 2:** Famous Quote 2: Repeat Exercise 1, but this time store the famous person’s name in a variable called 
//famous_person. Then compose your message and store it in a new variable called message. Print your messagto organize and use your data with variables.
let famous_person = "Albert Einstien";
let message = `${famous_person}, once said, "A person who never made a mistake
